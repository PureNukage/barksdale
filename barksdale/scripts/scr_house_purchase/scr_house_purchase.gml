...
if o_controller.resource_money < selection.array_abilities_price[selection.house,ability]{
	// ur too poor kid
	
} else {
	//deducting the payment 
	o_controller.resource_money = o_controller.resource_money - selection.array_abilities_price[selection.house,ability]
